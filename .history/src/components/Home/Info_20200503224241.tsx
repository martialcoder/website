...
export default () => (
  <Section spacing="20px 10px" style={{ alignItems: "center" }}>
    ...
    <p>
      ...
      memory. Both, martial arts and code development, had been part of my life
      since I have memory. I've been a professional{" "}
      <strong>Software Developer</strong> since 2008. I'm also a{" "}
      <strong>Wing Chun</strong> student.
    </p>
    <p>Both,</p>
    <p>
