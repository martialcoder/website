...
import { Cloud as CloudIcon } from "../styles/icons";
...
const Cloud = ({ xy, size = 0, offset }: any) => {
  return (
    <Magnet offset={offset} xy={xy} repel={0.2}>
      ...
      <CloudIcon width="100px" height="100px" />
    </Magnet>
  );
};
...
export default function HomeLogo() {
  ...
  useEffect(() => {
    setSizes({
      container: reference * 0.4,
      yingYang: reference * 0.4,
      cloud: reference * 0.2,
      meditation: reference * 0.2,
    });
  }, [reference]);
  return (
    <Container
